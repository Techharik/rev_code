...
console.log(
  "find --- ",
  arr.find((x) => x > 2),
); //takes of  a function and return first the matched conditions

console.log(
  "find --- ",
  arr.findIndex((x) => x > 2),
); //takes of  a function and return the matched conditions
console.log(
  "find --- ",
...
console.log(
  inputArray.sort((a, b) => reference.indexOf(a) - reference.indexOf(b)),
);
